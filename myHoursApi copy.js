function MyHoursApi(currentUser) {
    ...
    _this.addLogWithTime = function (start, end, comment, projectId = undefined, taskId = undefined, tagIds = undefined) {
        return new Promise(
            function (resolve, reject) {
                // console.info("api: adding log");
                var newLogData = {
    ...
    _this.startLog = function (comment, projectId = undefined, taskId = undefined, tagIds = undefined) {
        return new Promise(
            function (resolve, reject) {
                ...
                _this.getTaskLists().then(taskLists => {
                    ...
                    for (const taskList of taskLists) {
                        ...
                        if (projectTask) {
                            ...
                            _this.startLog('', taskList.projectId, projectTask.id, tagIds).then(
                                function (data) {
                                    logStarted = true;
